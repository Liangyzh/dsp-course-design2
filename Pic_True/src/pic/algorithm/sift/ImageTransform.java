...
import pic.utility.Math_Utility;
...
public class ImageTransform {
	...
	public static double finlinea,finlineb;
...
//			System.out.println(i+":"+j);
	...
	public static BufferedImage drawPoints(HashMap<Integer,double[][]> gaussPyramid,HashMap<Integer, List<MyPoint>> keyPoints){
		...
		double sumx=0,sumy=0,sumxy=0,sumx2=0,sumn=0;
		double a,b;
...
//		System.out.println("sumx"+sumx+" sumn"+sumn);
		a=(sumxy-sumx*sumy/sumn)/(sumx2-sumx*sumx/sumn);
		b=sumy/sumn-a*sumx/sumn;
		finlinea=a;
		finlineb=b;
